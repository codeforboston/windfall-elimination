...
import {EarningsEnum, EarningsRecord, PensionEnum, FutureEarningsEnum, FutureTrendEnum, UserProfile} from './user-state-context'
...
export interface UserStateActions {
  ...
  setTrendOrManualPrediction: (value: FutureEarningsEnum) => void
  setTrendSelection: (value: FutureTrendEnum) => void
