...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_GetAge')) {
        Object.defineProperty(Module['ready'], '_GetAge', { configurable: true, get: function() { abort('You are getting _GetAge on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_GetAge', { configurable: true, set: function() { abort('You are setting _GetAge on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_GetCalc')) {
        Object.defineProperty(Module['ready'], '_GetCalc', { configurable: true, get: function() { abort('You are getting _GetCalc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_GetCalc', { configurable: true, set: function() { abort('You are setting _GetCalc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_GetYears')) {
        Object.defineProperty(Module['ready'], '_GetYears', { configurable: true, get: function() { abort('You are getting _GetYears on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_GetYears', { configurable: true, set: function() { abort('You are setting _GetYears on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_InitalizeApplication')) {
        Object.defineProperty(Module['ready'], '_InitalizeApplication', { configurable: true, get: function() { abort('You are getting _InitalizeApplication on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_InitalizeApplication', { configurable: true, set: function() { abort('You are setting _InitalizeApplication on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
function nullFunc_didddi(x) { abortFnPtrError(x, 'didddi'); }
function nullFunc_didi(x) { abortFnPtrError(x, 'didi'); }
function nullFunc_didid(x) { abortFnPtrError(x, 'didid'); }
function nullFunc_didii(x) { abortFnPtrError(x, 'didii'); }
function nullFunc_didiid(x) { abortFnPtrError(x, 'didiid'); }
...
var asmLibraryArg = { "___cxa_allocate_exception": ___cxa_allocate_exception, "___cxa_begin_catch": ___cxa_begin_catch, "___cxa_throw": ___cxa_throw, "___exception_addRef": ___exception_addRef, "___exception_deAdjust": ___exception_deAdjust, "___gxx_personality_v0": ___gxx_personality_v0, "___map_file": ___map_file, "___sys_munmap": ___sys_munmap, "___syscall91": ___syscall91, "___wasi_fd_close": ___wasi_fd_close, "___wasi_fd_read": ___wasi_fd_read, "___wasi_fd_seek": ___wasi_fd_seek, "___wasi_fd_write": ___wasi_fd_write, "__addDays": __addDays, "__arraySum": __arraySum, "__embind_register_bool": __embind_register_bool, "__embind_register_class": __embind_register_class, "__embind_register_class_constructor": __embind_register_class_constructor, "__embind_register_class_function": __embind_register_class_function, "__embind_register_emval": __embind_register_emval, "__embind_register_float": __embind_register_float, "__embind_register_integer": __embind_register_integer, "__embind_register_memory_view": __embind_register_memory_view, "__embind_register_std_string": __embind_register_std_string, "__embind_register_std_wstring": __embind_register_std_wstring, "__embind_register_void": __embind_register_void, "__emval_decref": __emval_decref, "__emval_register": __emval_register, "__isLeapYear": __isLeapYear, "__memory_base": 1024, "__table_base": 0, "_abort": _abort, "_embind_repr": _embind_repr, "_emscripten_get_heap_size": _emscripten_get_heap_size, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_resize_heap": _emscripten_resize_heap, "_fd_close": _fd_close, "_fd_read": _fd_read, "_fd_seek": _fd_seek, "_fd_write": _fd_write, "_getenv": _getenv, "_llvm_stackrestore": _llvm_stackrestore, "_llvm_stacksave": _llvm_stacksave, "_llvm_trap": _llvm_trap, "_localtime_r": _localtime_r, "_strftime": _strftime, "_strftime_l": _strftime_l, "_time": _time, "_tzset": _tzset, "abort": abort, "abortStackOverflow": abortStackOverflow, "getTempRet0": getTempRet0, "memory": wasmMemory, "nullFunc_di": nullFunc_di, "nullFunc_didddi": nullFunc_didddi, "nullFunc_didi": nullFunc_didi, "nullFunc_didid": nullFunc_didid, "nullFunc_didii": nullFunc_didii, "nullFunc_didiid": nullFunc_didiid, "nullFunc_dii": nullFunc_dii, "nullFunc_diii": nullFunc_diii, "nullFunc_diiiii": nullFunc_diiiii, "nullFunc_fi": nullFunc_fi, "nullFunc_i": nullFunc_i, "nullFunc_ii": nullFunc_ii, "nullFunc_iidiiii": nullFunc_iidiiii, "nullFunc_iii": nullFunc_iii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_iiiii": nullFunc_iiiii, "nullFunc_iiiiid": nullFunc_iiiiid, "nullFunc_iiiiii": nullFunc_iiiiii, "nullFunc_iiiiiid": nullFunc_iiiiiid, "nullFunc_iiiiiii": nullFunc_iiiiiii, "nullFunc_iiiiiiii": nullFunc_iiiiiiii, "nullFunc_iiiiiiiii": nullFunc_iiiiiiiii, "nullFunc_iiiiij": nullFunc_iiiiij, "nullFunc_jiji": nullFunc_jiji, "nullFunc_v": nullFunc_v, "nullFunc_vi": nullFunc_vi, "nullFunc_vidi": nullFunc_vidi, "nullFunc_vif": nullFunc_vif, "nullFunc_vii": nullFunc_vii, "nullFunc_viid": nullFunc_viid, "nullFunc_viii": nullFunc_viii, "nullFunc_viiii": nullFunc_viiii, "nullFunc_viiiii": nullFunc_viiiii, "nullFunc_viiiiii": nullFunc_viiiiii, "nullFunc_viijii": nullFunc_viijii, "setTempRet0": setTempRet0, "table": wasmTable, "tempDoublePtr": tempDoublePtr };
// EMSCRIPTEN_START_ASM
var asm =Module["asm"]// EMSCRIPTEN_END_ASM
(asmGlobalArg, asmLibraryArg, buffer);

/** @type {function(...*):?} */
var _GetAge = Module["_GetAge"] = createExportWrapper("_GetAge");

/** @type {function(...*):?} */
var _GetCalc = Module["_GetCalc"] = createExportWrapper("_GetCalc");

/** @type {function(...*):?} */
var _GetYears = Module["_GetYears"] = createExportWrapper("_GetYears");

/** @type {function(...*):?} */
var _InitalizeApplication = Module["_InitalizeApplication"] = createExportWrapper("_InitalizeApplication");

/** @type {function(...*):?} */
var __ZSt18uncaught_exceptionv = Module["__ZSt18uncaught_exceptionv"] = createExportWrapper("__ZSt18uncaught_exceptionv");

/** @type {function(...*):?} */
var ___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = createExportWrapper("___embind_register_native_and_builtin_types");

/** @type {function(...*):?} */
var ___errno_location = Module["___errno_location"] = createExportWrapper("___errno_location");

/** @type {function(...*):?} */
var ___getTypeName = Module["___getTypeName"] = createExportWrapper("___getTypeName");

/** @type {function(...*):?} */
var __get_daylight = Module["__get_daylight"] = createExportWrapper("__get_daylight");

/** @type {function(...*):?} */
var __get_timezone = Module["__get_timezone"] = createExportWrapper("__get_timezone");

/** @type {function(...*):?} */
var __get_tzname = Module["__get_tzname"] = createExportWrapper("__get_tzname");

/** @type {function(...*):?} */
var _emscripten_get_sbrk_ptr = Module["_emscripten_get_sbrk_ptr"] = createExportWrapper("_emscripten_get_sbrk_ptr");

/** @type {function(...*):?} */
var _fflush = Module["_fflush"] = createExportWrapper("_fflush");

/** @type {function(...*):?} */
var _free = Module["_free"] = createExportWrapper("_free");

/** @type {function(...*):?} */
var _malloc = Module["_malloc"] = createExportWrapper("_malloc");

/** @type {function(...*):?} */
var _memcpy = Module["_memcpy"] = createExportWrapper("_memcpy");

/** @type {function(...*):?} */
var _memmove = Module["_memmove"] = createExportWrapper("_memmove");

/** @type {function(...*):?} */
var _memset = Module["_memset"] = createExportWrapper("_memset");

/** @type {function(...*):?} */
var globalCtors = Module["globalCtors"] = createExportWrapper("globalCtors");
...
/** @type {function(...*):?} */
var dynCall_didid = Module["dynCall_didid"] = createExportWrapper("dynCall_didid");

/** @type {function(...*):?} */
var dynCall_didii = Module["dynCall_didii"] = createExportWrapper("dynCall_didii");

/** @type {function(...*):?} */
var dynCall_didiid = Module["dynCall_didiid"] = createExportWrapper("dynCall_didiid");
