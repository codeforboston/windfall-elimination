...
var StateTree = /** @class */ /*#__PURE__*/function () {
    function StateTree(stateNode, stateValue, options) {
        ...
        this.nodes = stateValue ? typeof stateValue === 'string' ? (_a = {}, _a[stateValue] = new StateTree(stateNode.getStateNode(stateValue), undefined), _a) : mapValues(stateValue, function (subValue, key) {
