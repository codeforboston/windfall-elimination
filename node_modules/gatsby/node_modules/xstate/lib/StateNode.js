...
var StateNode = /** @class */ (function () {
                ...
                (_config.parallel
                    ...
                    : _config.states && utils_1.keys(_config.states).length
                        ...
                        : _config.history
                            ? 'history'
                            : 'atomic');
        if (!exports.IS_PRODUCTION && 'parallel' in _config) {
    ...
    StateNode.prototype.withConfig = function (options, context) {
        ...
        var _a = this.options, actions = _a.actions, activities = _a.activities, guards = _a.guards, services = _a.services;
    ...
    StateNode.prototype.getActions = function (transition, prevState) {
        ...
        var entryExitActions = {
            entry: utils_1.flatten(Array.from(new Set(entryExitStates.entry)).map(function (stateNode) {
                return __spread(stateNode.activities.map(function (activity) { return actions_1.start(activity); }), stateNode.onEntry, stateNode.delays.map(function (_a) {
    ...
    StateNode.prototype.resolveActivity = function (activity) {
        return actions_1.toActivityDefinition(activity);
    };
    ...
    StateNode.prototype.resolveTransition = function (stateTransition, currentState, eventObject) {
        ...
        }), 2), raisedEvents = _b[0], otherActions = _b[1];
        var _c = __read(utils_1.partition(otherActions, function (action) {
            return action.type === actionTypes.assign;
        }), 2), assignActions = _c[0], nonEventActions = _c[1];
        var updatedContext = utils_1.updateContext(currentState.context, eventObject, assignActions);
        var resolvedActions = nonEventActions.map(function (action) {
            ...
            if (actionObject.type === actionTypes.send) {
                return actions_1.resolveSend(actionObject, updatedContext, eventObject || { type: types_1.ActionTypes.Init }); // TODO: fix ActionTypes.Init
            }
    ...
    StateNode.prototype.getInitialState = function (stateValue, context) {
        ...
        var updatedContext = utils_1.updateContext(context, undefined, assignActions);
