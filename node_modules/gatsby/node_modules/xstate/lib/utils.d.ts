import { Event, StateValue, ActionType, Action, EventObject, StateInterface, PropertyMapper, Mapper, EventType, HistoryValue, OmniEventObject, AssignAction } from './types';
...
export declare function updateContext<TContext, TEvent extends EventObject>(context: TContext, event: OmniEventObject<TEvent> | undefined, assignActions: Array<AssignAction<TContext, TEvent>>): TContext;
